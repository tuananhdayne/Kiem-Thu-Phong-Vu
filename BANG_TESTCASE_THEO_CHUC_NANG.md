...
| TC_SEARCH_07 | Tìm kiếm chuỗi rất dài | Kiểm tra khả năng chịu tải input cực dài và phát hiện treo | Chuỗi rất dài, thao tác paste lặp | Nhập/paste chuỗi lớn vào ô tìm kiếm; tiếp tục paste đến khi không thêm được; thử click sản phẩm | Hệ thống vẫn phản hồi, ô tìm kiếm không bị trắng/đứng, vẫn nhập hoặc paste thêm trong giới hạn hợp lý và người dùng vẫn click được sản phẩm hoặc thao tác UI khác. Nếu thực tế bị treo/không click được thì testcase FAIL. | Critical |
